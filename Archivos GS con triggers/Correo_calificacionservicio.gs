function Correocalificacion() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('Calificación');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 54).setValue("Enviada");
  }
}

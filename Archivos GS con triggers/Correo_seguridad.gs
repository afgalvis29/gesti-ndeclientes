function Correoseguridad() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('seguridad');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 35).setValue("Enviada");
  }
}

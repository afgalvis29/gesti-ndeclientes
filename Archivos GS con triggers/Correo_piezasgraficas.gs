function Correopiezas() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('piezas');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 33).setValue("Enviada");
  }
}

function Correorenovación() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('renova');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 46).setValue("Enviada");
  }
}

function Correozonas() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('zonas');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 39).setValue("Enviada");
  }
}

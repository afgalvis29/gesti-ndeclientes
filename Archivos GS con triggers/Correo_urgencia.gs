function Correourgencia() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('urgencia');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 29).setValue("Enviada");
  }
}

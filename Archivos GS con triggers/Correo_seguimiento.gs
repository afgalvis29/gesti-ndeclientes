function Correoseguimiento() {
  ...
  var plantilla = HtmlService.createTemplateFromFile('seguimiento');
  ...
  if (nHojaDatos == nHojaActiva && filaActiva > filasencabezado && colActiva == colCondicion && valorActivo == valorcondicion) {
    ...
    celdaActiva.getSheet().getRange(filaActiva, 44).setValue("Enviada");
  }
}
